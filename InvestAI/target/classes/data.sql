...
INSERT INTO `cliente` (`id`, `user_id`, `codice_fiscale`, `data_nascita`, `telefono`, `indirizzo`, `profilo_rischio`, `data_registrazione`, `ultimo_accesso`) VALUES
('CL001', 1, 'RSSMRA80A01H501Z', '1980-01-01', '3331234567', 'Via Roma 1, Milano', 'MEDIO', NOW(), NOW());
